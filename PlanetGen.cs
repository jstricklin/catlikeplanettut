...
public class PlanetGen: MonoBehaviour
{
    ...
    private void CreateTriangles()
    {
        ...
        for (int i = 0, y = 0; y < gridSize; y++, v++, i++)
        {
    ...
    void SetUV()
    {
        // 6 total faces, 4 gridsize along U, 3 gridsize along V

        float u, v;
        float midV = 0.5f;
        float gridHalfV = gridSize * 0.5f / 3;
        float gridU = 1 / gridSize;
        float uUnit = 1 / (gridSize * 4f);
        float vUnit = 1 / (gridSize * 3f);
        ...
        //{
            ...
            u = 0f;
            v = 0f;
            sphereUV[i] = new Vector2(u, midV + gridHalfV);
            sphereUV[i + 1] = new Vector2(u + uUnit, midV);
            sphereUV[i + 2] = new Vector2(u + uUnit, v);
            sphereUV[i + 3] = new Vector2(u, midV - gridHalfV);
            //i += 4;

            Debug.Log(sphereUV[i]);
            Debug.Log(sphereUV[i + 1]);
            Debug.Log(sphereUV[i + 2]);
            Debug.Log(sphereUV[i + 3]);
            Debug.Log(uUnit);
        //}
