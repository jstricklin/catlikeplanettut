...
public class CubeSphereBckp: MonoBehaviour
{
    ...
    //private void GravCenter()
    //{
    //    GravSource grav = GetComponentInParent<GravSource>();
    //    Vector3 c = new Vector3(gridSize, gridSize, gridSize) * 0.5f;
    //    grav.GravityCenter(c);
    //}
    ...
    private void SetVertex(int i , int x, int y, int z)
    {
        ...
        //byte conversion allows for individual axis sizes to reach 255
